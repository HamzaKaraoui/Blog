...
class ActorViewModel extends ViewModel
{
    ...
    public function actor(){
        ...
        return collect($this->actor)->merge([
            ...
            ? 'https://images.tmdb.org/t/p/w300'.$this->actor['profile_path']
    ...
    public function KnownForMovie()
    {
        ...
        ->map(function($movie){
            return collect($movie)->merge([
                ...
                'title' => isset($movie['title']) ? $movie['title'] : 'Untiteld',
            ]);
        });
    }
    ...
    public function credits()
    {
        ...
        return collect($castMovie)->map(function($movie){
            ...
            }elseif(isset($movie['first_air_drop'])){
                $releaseDate = $movie['first_air_drop'];
            }else{
                $releaseDate = '';
            }
