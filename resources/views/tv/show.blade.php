...
<div class="tvShow-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="{{ $tvShow['poster_path'] }}" alt="poster" class="w-64 lg:w-66">
        </div>
        <div class="md:ml-24">
 ...
 <div class="tvShow-cast border-b borde-gray-800">

    <div class="container mx-auto px-2 py-8">
        <h2 class="text-4xl font-semibold">Cast</h2>

        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach ($tvShow['cast'] as $casts)
                <div class="mt-8">
                    <a href="">
                        <img src="{{ 'https://image.tmdb.org/t/p/w300/'.$casts['profile_path']}}" alt="actor1" class="w-64 lg:w-96">
                    </a>
                    <div class="mt-2">
                        <a href="" class="text-lg mt-2 hover:text-gray:300">{{$casts['name']}}</a>
