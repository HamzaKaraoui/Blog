    ...
    <div class="container mx-auto px-4 py-16 flex">
        ...
        <div class="md:ml-24">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-4">
                    <a href="#"><img src=" {{$movie['poster_path']}} "
                         alt="poster" class="hover:opacity-75 transition ease-in-out duration-150"></a>
                         <a href=" {{route('movie.show',$movie['id'])}} " class="text-sm leading-normal block text-gray-400 hover:text-white lt-1"> 
                             {{$movie['title']}}
                         </a>
                </div>
                @endforeach
...
<div class="credits border-b borde-gray-800">
